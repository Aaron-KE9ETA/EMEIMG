...
The `main` branch currently contains only this README and serves as the public landing page for the EMEIMG project.

Source code, working prototypes, packet-format experiments, and implementation documentation are maintained in separate development branches while the project transitions from Prototype toward Pre-Alpha.

Please review the active development branches for the current codebase and technical implementation details. The `main` branch will be populated as the project stabilizes and development work is ready to be consolidated.
